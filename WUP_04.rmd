...
Our response variable is "WORDSUM" which is numerical. Our predictor variable is "DEGREE" which is categorical. We will be using the Numerical~Cat helper file. 
