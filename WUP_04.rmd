...
We are given evidence that there is a difference in the test scores for the WORDSUM in relation to the level of degree. The higher educational degree an individual had, the higher test score they were likely to get. We know this by seeing if there is an interval of 0 in the testing/graph. If there is not, then there is no difference in the test scores; if there is then there is a difference in the test scores.
